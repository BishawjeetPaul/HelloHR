"""
Django settings for HelloHR project.
...
SECRET_KEY = 'p37h1^6aazx(3wtti@(hu^v%=t8ag-!gj#ihj(xej)2=ne3v'
...
WSGI_APPLICATION = "HelloHR.wsgi.application"
...
# This is for add CustomUser in models.py
