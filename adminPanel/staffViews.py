...
# This function is used to staff dashboard.
...
# This fuction is used to submit candidates.
@login_required(login_url="adminPanel:login")
@cache_control(no_cache=True, must_revalidate=True, no_store=True)
...
# This function is used to change staff password:
@login_required(login_url="adminPanel:login")
@cache_control(no_cache=True, must_revalidate=True, no_store=True)
def change_password(request):
    return render(request, 'staff-panel/change-password.html')


# This function is used to match staff password.
@login_required(login_url="adminPanel:login")
@cache_control(no_cache=True, must_revalidate=True, no_store=True)
def match_old_password(request):
    ...
    if not check_password(old_password, user.password):
        ...
        return HttpResponseRedirect(reverse('adminPanel:staff-change-password'))
    
    return HttpResponseRedirect(reverse('adminPanel:staff-update-password'))
...
def update_new_password(request):
    return render(request, 'staff-panel/match-password.html')
